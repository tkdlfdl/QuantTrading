...
| 116 | Harvey, Mazzoleni & Melone (NBER w33554) + Kayacetin (2026) | Rebalancing flows/TOM | 2026-08-17 | pending | TOP candidate: institutional rebalancing-flow front-run + TOM overlay, Sharpe ~1 net 1997-2023 from SPY+^TNX only, near-zero corr to all books — queue #36 |
...
| 118 | Gulen & Woeppel (2026), JFQA | Price-path convexity | 2026-08-17 | pending | 1.3-1.5%/mo decile spread, daily closes only; MUST corr-gate vs MR core — queue #38 |
| 119 | Stosik & Zaremba (2026) + core-defense thread | Reversal decay/defense | 2026-08-17 | pending | Raw ST reversal decayed globally BUT industry-adjusted persists (0.53%/mo); passive growth strengthens it. 5 OHLCV-only D upgrades specced — queue #39 |
